package com.canthny.dubbo.common.filter;
...
/**
 * @Author： Canthny
 * @Description： 链路追踪过滤器，用于生成链路id和spanid
 * @Date： Created in 2018/11/7 17:10
 */
...
public final class TracingFilter implements Filter {
    ...
    public Result invoke(Invoker<?> invoker, Invocation invocation) throws RpcException {
        if (tracer == null) setTracing(Tracing.newBuilder().build());
